...
} else if ( parseInt(jugador) !== 0 && parseInt(jugador) !== 1 && parseInt(jugador) !== 2 && jugador !== "ESC") {
...
} else if ( parseInt(oponente) !== 0 && parseInt(oponente) !== 1 && parseInt(oponente) !== 2 && oponente !== "ESC") {
    alert ("Eso no es un ataque 😅")
}
